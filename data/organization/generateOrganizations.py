...
organizations = getOpenData(
    datasetID, config.get("ORGANIZATIONS", "organizations"), dtype={'PARTITA-IVA': str, 'C-FISCALE': str})
...
legalStatuses = getOpenData(datasetID, config.get(
    "ORGANIZATIONS", "legal_statuses")).set_index(["CODICE"])
# %%
